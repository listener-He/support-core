...
import cn.hehouhui.proxy.bytebuddy.ByteBuddyProxyClient;
import cn.hehouhui.proxy.cglib.CglibProxyClient;
import cn.hehouhui.proxy.java.JavaProxyClient;
import cn.hehouhui.reflect.ClassUtil;

/**
 * 代理客户端，代理的class必须是公共可访问的（如果是内部类那么必须是静态内部类），请注意：
 * <ul>
 * <li>注意java代理客户端 {@link JavaProxyClient} 的特殊性</li>
...
public interface ProxyClient {
    ...
    static ProxyClient getInstance(ClientType type) {
        return ClassUtil.getInstance(type.clientClass);
    }
    ...
    enum ClientType {
         ...
         * CGLIB代理客户端
         * 
         * @see CglibProxyClient
         */
        CGLIB("cn.hehouhui.proxy.cglib.CglibProxyClient"),

        /**
         * ByteBuddy客户端
         * 
         * @see ByteBuddyProxyClient
         */
        BYTE_BUDDY("cn.hehouhui.proxy.bytebuddy.ByteBuddyProxyClient"),
         ...
         * @see JavaProxyClient
         */
        JAVA("cn.hehouhui.proxy.java.JavaProxyClient");
