...
import cn.hehouhui.shandard.Range;
...
public class DateUtil {
     ...
     */
    public static Range<LocalDate> getQuarter(LocalDate day) {
        // 计算当前月份属于第几季度
        int quarter = (day.getMonthValue() - 1) / 3 + 1;
        // 根据季度计算出本季度的开始月份
    ...
    public static long calc(String arg0, String arg1, String format, DateUnit dateUnit) {
        ...
        try {
            ...
            throw new CommonException(ErrorCodeEnum.UNKNOWN_EXCEPTION,
                StrUtil.format(msgTemp, arg0, arg1, format, dateUnit), e);
        }
    }
    ...
    public enum DateUnit {
        ...
        /** jdk装置 */
        private final ChronoUnit jdkUnit;
